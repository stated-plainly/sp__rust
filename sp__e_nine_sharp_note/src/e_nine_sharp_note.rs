...
impl Display for eNineSharpNote {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::CTripleSharp => write!(f, "{}", "C♯𝄪"),
        }
    }
}

impl tKeyboardFriendlyName for eNineSharpNote {
    fn get_keyboard_friendly_name(&self) -> String {
        match self {
            ...
            Self::CTripleSharp => "csss",
        }.to_string()
    }
}

impl TryFrom<(eNoteLetter, eNoteModifier)> for eNineSharpNote {
    ...
    fn try_from(value: (eNoteLetter, eNoteModifier)) -> Result<Self, Self::Error> {
        match value {
            ...
            (eNoteLetter::C, eNoteModifier::TripleSharp) => Ok(Self::CTripleSharp),
            // Failure
