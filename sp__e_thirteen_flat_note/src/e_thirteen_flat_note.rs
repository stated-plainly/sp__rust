...
impl Display for eThirteenFlatNote {
...
impl tKeyboardFriendlyName for eThirteenFlatNote {
...
impl TryFrom<(eNoteLetter, eNoteModifier)> for eThirteenFlatNote {
    ...
    fn try_from(value: (eNoteLetter, eNoteModifier)) -> Result<Self, Self::Error> {
        match value {
            ...
            // Failure
            (note, modifier) => Err(Box::new(sImpossibleOperationError::new(format!("{}{} cannot be converted to a 13♭ note", note, modifier).as_str()))),
        }
    }
}
